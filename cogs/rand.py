...
class randCog(commands.Cog):
    ...
    async def rand(self, ctx, *args):
        ...
        if not args: 
            embed=discord.Embed(title="Missing Datatype", description="This command requires an additional datatype argument. Note that each datatype has it's own sub-arguments. \n Datatypes: \n • **Float** \n", color=discord.Color.orange())
